...
export const VideoCall: React.FC = () => {
  ...
  return (
    <div className="flex h-lvh flex-col items-center bg-white p-3 rounded-xl shadow-lg">
      <h2 className="text-xl font-bold my-4">Agora 1-to-1 Video Call</h2>
      <div className="flex h-full w-full justify-center relative">
        <div className="w-full flex justify-center">
          <div className=" relative w-5/6 h-5/6 bg-white">
            ...
            ></div>
            <div className="w-[250px] h-[150px] bg-white rounded-md flex justify-center items-center absolute bottom-4 right-4 shadow-lg z-10">
              {!isVideoOn && (
                <h1 className="text-2xl w-10 h-10 overflow-hidden text-white justify-center flex items-center bg-red-500 p-8 rounded-full">
                  Q
                </h1>
              )}
            </div>
