          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="flex gap-2 overflow-x-auto pb-2 -mx-2 px-2">
                ...
                <button
                  type="button"
                  className={`min-w-[100px] p-3 border rounded-xl flex flex-col items-center justify-center transition-all flex-shrink-0 active:scale-95 ${role === "admin"
                      ? "border-primary-500 bg-primary-50"
                      : "border-gray-200 bg-white hover:border-primary-300"
                    }`}
        ...
        <div className="lg:w-2/5 bg-gradient-to-br from-primary-600 to-primary-800 p-8 lg:p-12 text-white relative overflow-hidden">
          <div className="relative z-10">
            {/* <div className="flex items-center gap-3 mb-8">
              <div className="w-44 h-44 bg-white rounded-lg flex items-center justify-center backdrop-blur-sm">
                <img
                src="/big-logo.png"
                alt="TrustBridge AI Logo"
                className="w-auto h-full object-contain"
    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <button
            type="button"
            className={`relative p-4 border-2 rounded-xl flex flex-col items-center justify-center transition-all duration-200 ${role === "entrepreneur"
                ? "border-primary-500 bg-primary-50"
          ...
          <button
            type="button"
            className={`relative p-4 border-2 rounded-xl flex flex-col items-center justify-center transition-all duration-200 ${role === "investor"
                ? "border-primary-500 bg-primary-50"
                : "border-gray-200 hover:border-gray-300"
              }`}
            onClick={() => setRole("investor")}
          ...
          <button
            type="button"
            className={`relative p-4 border-2 rounded-xl flex flex-col items-center justify-center transition-all duration-200 ${role === "admin"
                ? "border-primary-500 bg-primary-50"
                : "border-gray-200 hover:border-gray-300"
              }`}
            onClick={() => setRole("admin")}
