...
export const ThreeDotsButton: React.FC<ButtonProps> = ({
  variant = "primary",
  size = "md",
  fullWidth = false,
  isLoading = false,
  ...
  // Base styles
  const baseStyles =
    "inline-flex items-center justify-center font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-offset-2";
  ...
  const variantStyles = {
    ...
    ghost:
      "bg-transparent hover:bg-gray-300 transition-all duration-300 text-gray-700",
    link: "bg-transparent hover:text-primary-700 hover:underline focus:ring-primary-500 p-0",
    success:
